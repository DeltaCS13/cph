...
--
-- Database: `techrat_cph`
--

-- --------------------------------------------------------

--
-- Table structure for table `accesslevel_ual`
--

CREATE TABLE IF NOT EXISTS `accesslevel_ual` (
  `id_ual` int(11) NOT NULL,
  `accessLvl_ual` char(13) DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `accesslevel_ual`
--

INSERT INTO `accesslevel_ual` (`id_ual`, `accessLvl_ual`) VALUES
(1, 'Administrator'),
(2, 'Member');
...
--
-- Table structure for table `blog_blg`
--

CREATE TABLE IF NOT EXISTS `blog_blg` (
...
CREATE TABLE IF NOT EXISTS `comments_cmt` (
  `id_cmt` int(11) NOT NULL,
  `comment_cmt` longtext,
  `blog_blg_id_blg` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `condition_con`
--

CREATE TABLE IF NOT EXISTS `condition_con` (
  `id_con` int(11) NOT NULL,
  `condition_con` varchar(14) DEFAULT NULL,
  `description_con` varchar(255) DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `condition_con`
--

INSERT INTO `condition_con` (`id_con`, `condition_con`, `description_con`) VALUES
(1, 'New', 'Brand new in packaging'),
(2, 'Like New', 'Open packaging, Item never used'),
(3, 'Lightly Used', 'Item used but still in good condition'),
(4, 'Used', 'Obvious wear but still serviceable'),
(5, 'Well Used', 'In need of repair');

-- --------------------------------------------------------

--
-- Table structure for table `difficulty_dif`
--

CREATE TABLE IF NOT EXISTS `difficulty_dif` (
  `id_dif` int(11) NOT NULL,
  `difLevel_dif` varchar(20) DEFAULT NULL,
  `description_dif` varchar(250) DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `difficulty_dif`
--

INSERT INTO `difficulty_dif` (`id_dif`, `difLevel_dif`, `description_dif`) VALUES
(1, 'Easy', 'Beginner, little to no elevation change.'),
(2, 'Easy-Moderate', 'slight elevation change, beginner to intermediate.'),
(3, 'Moderate', 'Elevation changes, some climbing involved. intermediate'),
(4, 'Moderate-Difficult', 'Elevation changes, lots of ascending and descending, intermediate to advanced.'),
(5, 'Difficult', 'For advanced hikers, lots of ascending and descending, some obstacles.'),
(6, 'Difficult-Advanced', 'Advanced Hikers Only, ascending and descending in excess of 4000 feet, major obstacles');

-- --------------------------------------------------------

--
-- Table structure for table `events_evt`
--

CREATE TABLE IF NOT EXISTS `events_evt` (
  `id_evt` int(11) NOT NULL,
  `name_evt` varchar(45) DEFAULT NULL,
  `location_evt` varchar(100) DEFAULT NULL,
  `description_evt` varchar(255) DEFAULT NULL,
  `dateTime_evt` varchar(17) DEFAULT NULL,
  `subregions_sre_id_sre` int(10) unsigned NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `events_evt`
--

INSERT INTO `events_evt` (`id_evt`, `name_evt`, `location_evt`, `description_evt`, `dateTime_evt`, `subregions_sre_id_sre`) VALUES
(1, 'Moon Light Hike', 'Laural River Trail', '7 mile hike starts at dusk and finishes by moonlight', '6/13/2015 7:00pm', 3707),
(2, 'Valentines Hike', 'Lovers Leap', 'Hike to Lovers Leap in Hot Springs', '2/14/2015 9:00am', 3707),
(3, 'Get to Know You', 'NC Arboretum', 'Meet fellow CPH Members at the NC Arboretum', '4/18/2015 10:00am', 3707),
(4, 'AT Prep', 'Mars Hill Massage Therapy', 'For those who are interested in Thru hiking the AT. Located at 705a Carl Eller Rd., Mars Hill, NC', '11/12/2015 7:00pm', 3707);

-- --------------------------------------------------------

--
-- Table structure for table `gearexchange_gex`
--

CREATE TABLE IF NOT EXISTS `gearexchange_gex` (
  `id_gex` int(11) NOT NULL,
  `dateAdded_gex` date DEFAULT NULL,
  `name_gex` varchar(100) DEFAULT NULL,
...
INSERT INTO `gearexchange_gex` (`id_gex`, `dateAdded_gex`, `name_gex`, `condition_con_id_con`, `description_gex`, `user_usr_id_usr`) VALUES
...
--
-- Table structure for table `genhikelist_ghl`
--

CREATE TABLE IF NOT EXISTS `genhikelist_ghl` (
  `id_ghl` int(11) NOT NULL,
  `name_ghl` varchar(125) DEFAULT NULL,
  `nearestCity_ghl` varchar(50) DEFAULT NULL,
  `subregions_sre_id_sre` int(10) unsigned NOT NULL,
  `length_ghl` decimal(10,0) DEFAULT NULL,
  `link_ghl` varchar(250) DEFAULT NULL,
  `difficulty_dif_id_dif` int(11) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `genhikelist_ghl`
--

INSERT INTO `genhikelist_ghl` (`id_ghl`, `name_ghl`, `nearestCity_ghl`, `subregions_sre_id_sre`, `length_ghl`, `link_ghl`, `difficulty_dif_id_dif`) VALUES
(1, 'Appalachian Trail', 'Springer, GA-Mount Katahdin, ME', 3690, '2180', 'http://www.appalachiantrail.org/', 6),
(2, 'Pacific Crest Trail', 'Clingman''s Dome-Jockey''s Ridge State Park', 3707, '1150', 'http://www.pcta.org/', 6),
(3, 'Laural River Trail', 'Hot Springs', 3707, '7', 'http://www.exploreasheville.com/things-to-do/hiking-trails/laurel-river-trail/', 2),
(4, 'Oyacachi to El Chaco Hike', 'Oyacachi', 902, '26', 'http://www.ecuadorexplorer.com/html/hiking.html#oyacachi', 5),
(5, 'Summit Trail', 'Elk Knob State Park', 3707, '2', 'http://www.hikewnc.info/trails/elk-knob-state-park/summit', 5);

-- --------------------------------------------------------

--
-- Table structure for table `hikewishlist_hwl`
--

CREATE TABLE IF NOT EXISTS `hikewishlist_hwl` (
  `id_hwl` int(11) NOT NULL,
  `user_usr_id_usr` int(11) NOT NULL,
  `genHikeList_ghl_id_ghl` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `level_lvl`
--

CREATE TABLE IF NOT EXISTS `level_lvl` (
  `id_lvl` int(11) NOT NULL,
  `name_lvl` char(11) DEFAULT NULL,
  `description_lvl` varchar(20) DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `level_lvl`
--

INSERT INTO `level_lvl` (`id_lvl`, `name_lvl`, `description_lvl`) VALUES
(1, 'Sprout', '0 - 100 Miles Hiked'),
(2, 'Spud', '101-500 Miles Hiked'),
(3, 'Tater', '501 - 1000 Miles Hik'),
(4, 'Potato', '1001 - 2000 Miles Hi'),
(5, 'Super Tater', '2000 + Miles Hiked');

-- --------------------------------------------------------

--
-- Table structure for table `regions_cou`
--

CREATE TABLE IF NOT EXISTS `regions_cou` (
  `id_cou` int(10) unsigned NOT NULL,
  `iso_cou` varchar(45) DEFAULT NULL,
  `iso3_cou` varchar(45) DEFAULT NULL,
  `fips_cou` varchar(45) DEFAULT NULL,
  `country_cou` varchar(45) DEFAULT NULL,
  `continent_cou` varchar(45) DEFAULT NULL,
  `currency_code_cou` varchar(45) DEFAULT NULL,
  `currency_name_cou` varchar(45) DEFAULT NULL,
  `phone_prefix_cou` varchar(45) DEFAULT NULL,
  `postal_code_cou` varchar(45) DEFAULT NULL,
  `languages_cou` varchar(45) DEFAULT NULL,
  `geonameid_cou` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `regions_cou`
--

INSERT INTO `regions_cou` (`id_cou`, `iso_cou`, `iso3_cou`, `fips_cou`, `country_cou`, `continent_cou`, `currency_code_cou`, `currency_name_cou`, `phone_prefix_cou`, `postal_code_cou`, `languages_cou`, `geonameid_cou`) VALUES
...
--
-- Table structure for table `subregions_sre`
--

CREATE TABLE IF NOT EXISTS `subregions_sre` (
  `id_sre` int(10) unsigned NOT NULL,
  `region_id_sre` int(10) unsigned DEFAULT NULL,
  `name_sre` varchar(45) DEFAULT NULL,
  `timezone_sre` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `subregions_sre`
--

INSERT INTO `subregions_sre` (`id_sre`, `region_id_sre`, `name_sre`, `timezone_sre`) VALUES
...
--
-- Table structure for table `useraddress_uad`
--

CREATE TABLE IF NOT EXISTS `useraddress_uad` (
  `id_uad` int(11) NOT NULL,
  `user_usr_id_usr` int(11) NOT NULL,
  `type_uad` char(8) DEFAULT NULL,
  `address1_uad` varchar(45) NOT NULL,
  `address2_uad` varchar(45) DEFAULT NULL,
  `address3_uad` varchar(45) DEFAULT NULL,
  `city_uad` varchar(35) DEFAULT NULL,
  `subregions_sre_id_sre` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `userhikelog_uhl`
--

CREATE TABLE IF NOT EXISTS `userhikelog_uhl` (
  `id_uhl` int(11) NOT NULL,
  `name_uhl` varchar(125) DEFAULT NULL,
  `nearestCity_uhl` varchar(50) DEFAULT NULL,
  `subregions_sre_id_sre` int(10) unsigned NOT NULL,
  `difficulty_dif_id_dif` int(11) NOT NULL,
  `length_uhl` decimal(10,0) DEFAULT NULL,
  `dateHiked_uhl` date DEFAULT NULL,
  `link_uhl` varchar(250) DEFAULT NULL,
  `user_usr_id_usr` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `user_usr` (
  ...
  `firstName_usr` varchar(20) DEFAULT NULL,
  `lastName_usr` varchar(35) DEFAULT NULL,
  `nickName_usr` varchar(15) NOT NULL,
...
--
-- Indexes for table `accesslevel_ual`
--
ALTER TABLE `accesslevel_ual`
  ADD PRIMARY KEY (`id_ual`), ADD UNIQUE KEY `accessLvl_aml_UNIQUE` (`accessLvl_ual`);

--
-- Indexes for table `blog_blg`
--
ALTER TABLE `blog_blg`
  ADD PRIMARY KEY (`id_blg`), ADD KEY `fk_blog_blg_user_usr1_idx` (`user_usr_id_usr`);

--
-- Indexes for table `comments_cmt`
--
ALTER TABLE `comments_cmt`
  ADD PRIMARY KEY (`id_cmt`), ADD KEY `fk_comments_cmt_blog_blg1_idx` (`blog_blg_id_blg`);

--
-- Indexes for table `condition_con`
--
ALTER TABLE `condition_con`
  ADD PRIMARY KEY (`id_con`), ADD UNIQUE KEY `condition_con_UNIQUE` (`condition_con`);

--
-- Indexes for table `difficulty_dif`
--
ALTER TABLE `difficulty_dif`
  ADD PRIMARY KEY (`id_dif`), ADD UNIQUE KEY `difLevel_dif_UNIQUE` (`difLevel_dif`);

--
-- Indexes for table `events_evt`
--
ALTER TABLE `events_evt`
  ADD PRIMARY KEY (`id_evt`), ADD UNIQUE KEY `dateTime_evt_UNIQUE` (`dateTime_evt`), ADD KEY `fk_events_subregions_sre1_idx` (`subregions_sre_id_sre`);
...
--
ALTER TABLE `genhikelist_ghl`
  ADD PRIMARY KEY (`id_ghl`), ADD UNIQUE KEY `name-ghll_UNIQUE` (`name_ghl`), ADD KEY `fk_genHikeList_ghl_subregions_sre1_idx` (`subregions_sre_id_sre`), ADD KEY `fk_genHikeList_ghl_difficulty_dif1_idx` (`difficulty_dif_id_dif`);

--
-- Indexes for table `hikewishlist_hwl`
--
ALTER TABLE `hikewishlist_hwl`
  ADD PRIMARY KEY (`id_hwl`), ADD UNIQUE KEY `id_hwl_UNIQUE` (`id_hwl`), ADD KEY `fk_hikeWishList_hwl_user_usr_idx` (`user_usr_id_usr`), ADD KEY `fk_hikeWishList_hwl_genHikeList_ghl1_idx` (`genHikeList_ghl_id_ghl`);

--
-- Indexes for table `level_lvl`
--
ALTER TABLE `level_lvl`
  ADD PRIMARY KEY (`id_lvl`), ADD UNIQUE KEY `name_lvl_UNIQUE` (`name_lvl`);

--
-- Indexes for table `regions_cou`
--
ALTER TABLE `regions_cou`
  ADD PRIMARY KEY (`id_cou`);

--
-- Indexes for table `subregions_sre`
--
ALTER TABLE `subregions_sre`
  ADD PRIMARY KEY (`id_sre`), ADD KEY `subregion_region_id` (`region_id_sre`);

--
-- Indexes for table `useraddress_uad`
--
ALTER TABLE `useraddress_uad`
  ADD PRIMARY KEY (`id_uad`), ADD UNIQUE KEY `email_uad_UNIQUE` (`email_uad`), ADD KEY `fk_userAddress_uad_user_usr1_idx` (`user_usr_id_usr`), ADD KEY `fk_userAddress_uad_subregions_sre1_idx` (`subregions_sre_id_sre`);

--
-- Indexes for table `userhikelog_uhl`
--
ALTER TABLE `userhikelog_uhl`
  ADD PRIMARY KEY (`id_uhl`), ADD UNIQUE KEY `id_uhl_UNIQUE` (`id_uhl`), ADD KEY `fk_userHikeLog_uhl_user_usr1_idx` (`user_usr_id_usr`), ADD KEY `fk_userHikeLog_uhl_difficulty_dif1_idx` (`difficulty_dif_id_dif`), ADD KEY `fk_userHikeLog_uhl_subregions_sre1_idx` (`subregions_sre_id_sre`);

--
-- Indexes for table `user_usr`
--
ALTER TABLE `user_usr`
  ADD PRIMARY KEY (`id_usr`), ADD UNIQUE KEY `nickName_usr_UNIQUE` (`nickName_usr`), ADD KEY `fk_user_usr_level_lvl1_idx` (`level_lvl_id_lvl`), ADD KEY `fk_user_usr_accessLevel_ual1_idx` (`accessLevel_ual_id_ual`);
...
--
-- AUTO_INCREMENT for table `accesslevel_ual`
--
ALTER TABLE `accesslevel_ual`
  MODIFY `id_ual` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `blog_blg`
--
ALTER TABLE `blog_blg`
  MODIFY `id_blg` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `comments_cmt`
--
ALTER TABLE `comments_cmt`
  MODIFY `id_cmt` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `condition_con`
--
ALTER TABLE `condition_con`
  MODIFY `id_con` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `difficulty_dif`
--
ALTER TABLE `difficulty_dif`
  MODIFY `id_dif` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `events_evt`
--
ALTER TABLE `events_evt`
  MODIFY `id_evt` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `genhikelist_ghl`
  MODIFY `id_ghl` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `hikewishlist_hwl`
--
ALTER TABLE `hikewishlist_hwl`
  MODIFY `id_hwl` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `level_lvl`
--
ALTER TABLE `level_lvl`
...
--
ALTER TABLE `userhikelog_uhl`
  MODIFY `id_uhl` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- Constraints for table `blog_blg`
--
ALTER TABLE `blog_blg`
ADD CONSTRAINT `fk_blog_blg_user_usr1` FOREIGN KEY (`user_usr_id_usr`) REFERENCES `user_usr` (`id_usr`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `comments_cmt`
--
ALTER TABLE `comments_cmt`
ADD CONSTRAINT `fk_comments_cmt_blog_blg1` FOREIGN KEY (`blog_blg_id_blg`) REFERENCES `blog_blg` (`id_blg`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `events_evt`
--
ALTER TABLE `events_evt`
ADD CONSTRAINT `fk_events_subregions_sre1` FOREIGN KEY (`subregions_sre_id_sre`) REFERENCES `subregions_sre` (`id_sre`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `gearexchange_gex`
--
ALTER TABLE `gearexchange_gex`
ADD CONSTRAINT `fk_gearExchange_gex_condition_con1` FOREIGN KEY (`condition_con_id_con`) REFERENCES `condition_con` (`id_con`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_gearExchange_gex_user_usr1` FOREIGN KEY (`user_usr_id_usr`) REFERENCES `user_usr` (`id_usr`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `genhikelist_ghl`
--
ALTER TABLE `genhikelist_ghl`
ADD CONSTRAINT `fk_genHikeList_ghl_difficulty_dif1` FOREIGN KEY (`difficulty_dif_id_dif`) REFERENCES `difficulty_dif` (`id_dif`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_genHikeList_ghl_subregions_sre1` FOREIGN KEY (`subregions_sre_id_sre`) REFERENCES `subregions_sre` (`id_sre`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `hikewishlist_hwl`
--
ALTER TABLE `hikewishlist_hwl`
ADD CONSTRAINT `fk_hikeWishList_hwl_genHikeList_ghl1` FOREIGN KEY (`genHikeList_ghl_id_ghl`) REFERENCES `genhikelist_ghl` (`id_ghl`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_hikeWishList_hwl_user_usr` FOREIGN KEY (`user_usr_id_usr`) REFERENCES `user_usr` (`id_usr`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `subregions_sre`
--
ALTER TABLE `subregions_sre`
ADD CONSTRAINT `subregion_region_id` FOREIGN KEY (`region_id_sre`) REFERENCES `regions_cou` (`id_cou`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `useraddress_uad`
--
ALTER TABLE `useraddress_uad`
ADD CONSTRAINT `fk_userAddress_uad_subregions_sre1` FOREIGN KEY (`subregions_sre_id_sre`) REFERENCES `subregions_sre` (`id_sre`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_userAddress_uad_user_usr1` FOREIGN KEY (`user_usr_id_usr`) REFERENCES `user_usr` (`id_usr`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `userhikelog_uhl`
--
ALTER TABLE `userhikelog_uhl`
ADD CONSTRAINT `fk_userHikeLog_uhl_difficulty_dif1` FOREIGN KEY (`difficulty_dif_id_dif`) REFERENCES `difficulty_dif` (`id_dif`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_userHikeLog_uhl_subregions_sre1` FOREIGN KEY (`subregions_sre_id_sre`) REFERENCES `subregions_sre` (`id_sre`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_userHikeLog_uhl_user_usr1` FOREIGN KEY (`user_usr_id_usr`) REFERENCES `user_usr` (`id_usr`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `user_usr`
--
ALTER TABLE `user_usr`
ADD CONSTRAINT `fk_user_usr_accessLevel_ual1` FOREIGN KEY (`accessLevel_ual_id_ual`) REFERENCES `accesslevel_ual` (`id_ual`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_user_usr_level_lvl1` FOREIGN KEY (`level_lvl_id_lvl`) REFERENCES `level_lvl` (`id_lvl`) ON DELETE NO ACTION ON UPDATE NO ACTION;
